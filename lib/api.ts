...
export const fetchMatches = () =>
  api.get<Match[]>('/api/public/matches').then((r) => r.data)

export const fetchLiveMatches = () =>
  api.get<Match[]>('/api/public/matches?status=live').then((r) => r.data)

export const fetchMatchById = (id: string) =>
  api.get<Match>(`/api/public/match/${id}`).then((r) => r.data)

export const fetchUpcomingMatches = () =>
  api.get<Match[]>('/api/public/matches?status=upcoming').then((r) => r.data)

// ── Teams ────────────────────────────────────────────────────────────────────
export const fetchTeams = () =>
  api.get<Team[]>('/api/public/teams').then((r) => r.data)

export const fetchTeamById = (id: string) =>
  api.get<Team>(`/api/public/teams/${id}`).then((r) => r.data)

// ── Venues ───────────────────────────────────────────────────────────────────
export const fetchVenues = () =>
  api.get<Venue[]>('/api/public/venues').then((r) => r.data)

// ── Tournament ───────────────────────────────────────────────────────────────
export const fetchTournament = () =>
  api.get<Tournament>('/api/public/tournament').then((r) => r.data)
